#!/usr/bin/env bash
# setup.sh — One-time Bluetooth audio setup for Artix Linux (runit + PipeWire)
...
# ── 2. Enable bluetoothd via runit ────────────────────────────────────────────
info "Enabling bluetoothd runit service..."
...
# ── 4. sudoers for btmgmt and rfkill ─────────────────────────────────────────
